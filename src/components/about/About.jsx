    ...
    <Grid id='about'>
      <Row>
        <Col className='text-center'>
          ...
          <hr/>
          <p className='about__title_bottom'>I’m New York’s finest Front-End Developer/Javascript Full-Stack Developer. I’m always hungry regardless of my experience, background or skill level. I have been constantly evolving and adapting to change as a developer for last 5
          years. I can be enthusiastic and versatile at any angle to take on new problems across the full-stack. I can thrive in a fast-paced work environment and my colleagues often call
